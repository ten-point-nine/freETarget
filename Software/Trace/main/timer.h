 ...
 * function Prototypes
 */
bool ft_timer_new(time_count_64_t *timer_new, time_count_64_t duration, void *(callback)(), char *name); // Start a new timer in ms
...
time_count_64_t run_time_us(void);       // Show how long we have been running for in us
