...
namespace freETarget {
    ...
    public class EventManager {
        ...
        public void initializeEvents() {
            ...
            //air pistol final
            Event evAPF = new Event(-1, "Pistol Final", true, Event.EventType.Final, 24, new targets.AirPistol(4.5m), -1, 4.5m, 5, 250, 10, 2, 50, Color.Red);
            ...
            //air rfile final
            Event evARF = new Event(-1, "Rifle Final", true, Event.EventType.Final, 24, new targets.AirRifle(4.5m), -1, 4.5m, 5, 250, 10, 2, 50, Color.DodgerBlue);
