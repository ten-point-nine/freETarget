        ...
        private void btnUpload_Click(object sender, EventArgs e) {
            ...
            using (System.Diagnostics.Process pProcess = new System.Diagnostics.Process()) {
                if (Properties.Settings.Default.Board == frmMainWindow.Arduino) {
                    ...
                    string bootLoader = "./binary/bootloader.bin";

                    string additionalFilesPath = "";
                    if(File.Exists(partitionBin) && File.Exists(otaDataBin) && File.Exists(bootLoader) ) {
                        additionalFilesPath = " 0x0 " + bootLoader + " 0x8000 " + partitionBin +" 0xd000 " + otaDataBin;
