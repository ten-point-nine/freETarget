...
int     json_rapid_count;           // Number of shots in one cycle
...
//    token                 value stored in RAM     double stored in RAM        convert    service fcn()     NONVOL location      Initial Value
  ...
  {"\"RAPID_COUNT\":",    &json_rapid_count,                 0,                IS_INT16,  0,                0,                       0 },    // Count of shots in the rapid fire event
  {"\"RAPID_ENABLE\":",   &json_rapid_enable,                0,                IS_INT16,  0,                0,                       0 },    // Enable the rapid fire fieature
  {"\"RAPID_TIME\":",     0,                                 0,                IS_INT16,  &rapid_start,     0,                       0 },    // Set the duration of the rapid fire event and start
