...
#define DLT_CALIBRATION_VERBOSE (DLT_CALIBRATION << 1)         // Debug the calibraition software
#define DLT_HEARTBEAT           (DLT_CALIBRATION_VERBOSE << 1) // Kick out the time to see if we are alive
