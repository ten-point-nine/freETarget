...
#define AUX_LISTEN     (ETHERNET << 1)                         // 0x20 Listen for broadcast messages on the AUX port.
#define TCPIP_0        (AUX_LISTEN << 1)                       // 0x20
...
#define AUX_PORT (AUX | BLUETOOTH | RS485 | ETHERNET ) //
