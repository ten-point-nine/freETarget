...
const json_message_t JSON[] = {
    ...
    {HIDE,        "\"TABATA_ON\":",      &json_tabata_on,             IS_FLOAT,                 0,                  NONVOL_TABATA_ON,           7,          16},
    {HIDE,        "\"TABATA_REST\":",    &json_tabata_rest,           IS_FLOAT,                 0,                  NONVOL_TABATA_REST,         30,         16},
    {HIDE,        "\"TABATA_WARN_ON\":", &json_tabata_warn_on,        IS_FLOAT,                 0,                  NONVOL_TABATA_WARN_ON,      3,          16},
