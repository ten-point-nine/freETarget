...
const json_message_t JSON[] = {
    ...
    {"\"50M\":", 0, IS_VOID, &set_50m, 0, 0, 0}, // Setup values for 50m pistol
    ...
    {"\"SENSOR\":", (int *)&json_sensor_dia, IS_FLOAT, 0, NONVOL_SENSOR_DIA, 232000, 0}, // Generate the sensor postion array
