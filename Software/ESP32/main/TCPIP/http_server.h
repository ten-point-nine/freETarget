 ...
 * Global functions
 */
httpd_handle_t start_webserver_80(void);                                                          // Turn it on and let it go
httpd_handle_t start_webserver_81(void);                                                          // Event server on port 81
...
#define EVENT_SERVER_PORT   81 // Use por t81 for the event server
#endif
