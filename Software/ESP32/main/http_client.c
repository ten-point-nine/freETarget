...
/*----------------------------------------------------------------
 *
 * @function: http_rest_init
 *
 * @brief: Initialize the HTTP client requests
 * 
 * @return: None
 *
 *----------------------------------------------------------------
 ...
 *
 * @brief: Function to handle HTTP events
 * 
 * @return: None
 *
 *----------------------------------------------------------------
 ...
 *
 * @brief: Issue an HTTP request to a REST server
 * 
 * @return: None
 *
 *----------------------------------------------------------------
...
(
    char* url,              // URL to send data to
    char* post_data         // Data to send 
)
{
    ...
    // POST
    esp_http_client_set_url(client, json_remote_url);
...
/*----------------------------------------------------------------
 *
 * @function: http_rest_with_hostname_path
 *
 * @brief: Issue an HTTP request to a REST server
 * 
 * @return: None
...
{
    http_rest_with_url(json_remote_url, "Hello World");
